...
VARIANTS=('longer','equal_source','response_selection','wider','dimension4','dimension4_response','lj_edges','lj_edges_response')
...
def main():
    ...
    for variant in VARIANTS:
        for seed in (3456456,123,456,786,2026):
            ...
            cmd=['/opt/pbs/bin/qsub','-N',f'lss_ae_{variant[:7]}_{seed}','-v',f'LSS_VARIANT={variant},LSS_SEED={seed}','scripts/lj_ae_repair.pbs']
