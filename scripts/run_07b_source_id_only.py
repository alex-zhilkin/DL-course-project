"""Run the 07b propagator with source identity but no graph-context embedding."""
...
config, _ = namespace["build_config"]("B_source_id_only", use_static_context=True)
...
config["cache_path"] = str(
    AE_CACHE.with_name("mixed4source_B_source_id_only_stored13_train20_100frames.pt")
)
