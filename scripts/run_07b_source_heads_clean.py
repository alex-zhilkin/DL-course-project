"""Run 07b with source-specific residual heads and exact one-hot context."""
...
config, _ = namespace["build_config"]("B_source_heads_clean", use_static_context=True)
...
config["cache_path"] = str(
    AE_CACHE.with_name("mixed4source_B_source_heads_clean_stored13_train20_100frames.pt")
)
