...
def main():
    ...
    output=ROOT/f'notebooks/results/latent_low_data/{args.scope}_d2_s{args.seed}'
    ...
    cfg['ae_config']['train_rows_per_source']=101
    ...
    (output/'recipe.json').write_text(json.dumps(dict(source=source,config=cfg,matched_recipe=str(original/'recipe.json'),
        design='Same 40-epoch/patience-8 recipe and frames 0–100; training budget 1 vs 30 trajectories/source. Not update-matched or an exact historical reproduction.',
